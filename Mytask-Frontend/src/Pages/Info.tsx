...
export function Info() {
  return (
    <div className="relative w-screen h-screen bg-black overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-1/4 rotate-45 opacity-60">
        <GradientCard />
      </div>
      ...
      <div className="relative h-full flex flex-col items-center justify-center px-4">
        ...
        <div className="text-center space-y-8 max-w-2xl">
          <h1 className="font-kubo text-4xl md:text-6xl text-white mb-4">
            Welcome to the Future
          </h1>
          <p className="text-gray-300 text-xl mb-8">
            Exploring the boundaries of design and technology
          </p>
          
          {/* CTA Button */}
          <button className="px-8 py-3 bg-transparent border-2 border-white text-white 
                           hover:bg-white hover:text-black transition-all duration-300 
                           rounded-full font-kubo text-lg">
            Get Started
          </button>
        </div>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 
                      flex space-x-4 text-white/50 text-sm">
