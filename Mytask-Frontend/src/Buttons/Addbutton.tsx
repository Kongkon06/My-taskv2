...
export function Addbutton({parentId}:{parentId?:number}) {
    ...
    return (
        <div className="w-full relative inline-block text-left">
            ...
            <div
                role={'button'}
                className={`z-20 flex justify-center items-center bg-indigo-900 font-dm-sans rounded-md font-semibold text-white p-2 w-full mobile:h-full mobile:text-sm lg:h-48 lg:text-2xl`}
