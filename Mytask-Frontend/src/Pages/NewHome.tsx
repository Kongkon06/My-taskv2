...
export function NewHome() {
  ...
  return <div className="h-screen ">
    <Appbar />
    <div className="py-12 px-4 flex bg-indigo-800 h-full">
      <div className="h-full w-1/5 mt-8 mr-5 bg-red-400">
        <NewSidebar />
      </div>
      <div className="h-full w-full font-dm-sans mt-8 grid grid-cols-8 grid-rows-3 gap-5">
