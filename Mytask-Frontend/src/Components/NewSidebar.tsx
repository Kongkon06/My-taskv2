...
export function NewSidebar() {
  ...
  return <div className="h-full w-full text-xl flex flex-col font-dm-sans justify-content">
    ...
    <div className="flex mb-3 gap-4">
      ...
      <div role="button" onClick={() => navigate('/goals')}>Goals</div>
    </div>
    <div className="flex mb-3 gap-4">
      <div><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="size-6">
