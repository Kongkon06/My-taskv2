...
export function Auth({ type }: { type: "signup" | "signin" }) {
  ...
  return (
    <div className="relative h-screen font-dm-sans text-white bg-slate-900 flex justify-center">
      ...
      <div className="text-red-600 flex justify-center text-center sm:text-lg font-goldman lg:text-2xl">*The App is still in Developement Phase and Soon be notified*</div>
